...
sensors3 = { "lightSensor.brightness": 0,
             "lightSensor.resistance": 0 }
...
class lightSensor:
   ...
   def getValue3(self):
      print "getting light sensor values v3..."
      return_json = {}
      # Get sensor value
      sensor_value = grovepi.analogRead(self.port)
      ...
      sensors3["lightSensor.brightness"] = sensor_value
      sensors3["lightSensor.resistance"] = int(resistance)
